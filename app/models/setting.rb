class Setting < Tag
  ...
  has_many :parent_setting_tags, class_name: 'TagTag', foreign_key: :tag_id, inverse_of: :parent_setting, dependent: :destroy
  has_many :child_setting_tags, class_name: 'TagTag', foreign_key: :tagged_id, inverse_of: :child_setting, dependent: :destroy
  ...
  has_tags(parent_setting: Setting)
